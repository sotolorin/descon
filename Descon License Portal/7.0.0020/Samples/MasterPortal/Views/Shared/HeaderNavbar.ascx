...
<% var signInUrl = !isAuthenticated ? Html.Action("SignInUrl", "Layout", new { area = "Portal" }, true) : null; %>
...
<% var signOutUrl = isAuthenticated ? Html.Action("SignOutUrl", "Layout", new { area = "Portal" }, true) : null; %>
...
<% var registerUrl = registrationEnabled ? Html.Action("RegisterUrl", "Layout", new { area = "Portal" }, true) : null; %>
					...
					<div class="btn-toolbar" role="toolbar" >
						...
						<% if (shoppingCartEnabled) { %>
							<div class="btn-group shopping-cart-status" data-href="<%: shoppingCartServiceUrl %>">
								<a class="btn btn-default" href="<%: shoppingCartUrl %>">
							...
							<div class="btn-group">
								...
								<ul class="dropdown-menu pull-right" role="menu">
									<% if (profileNavEnabled) { %>
										...
										<% } %>
									<% } else { %>
										<li><a href="<%: profileUrl %>"><%: profileLinkText %></a></li>
									<% } %>
						...
						<% } else { %>
							<% if (registrationEnabled) { %>
								<div class="btn-group">
									<a class="btn btn-default" href="<%: registerUrl %>">
										<%: registerLabel %>
									</a>
								</div>
							<% } %>
							<% if (signInEnabled) { %>	
								<div class="btn-group">
									<a class="btn btn-primary" href="<%: signInUrl %>">
...
<div class="header-navbar navbar navbar-default navbar-static-top" role="navigation"  style="width: 5px !important;">
	<div class="container">
