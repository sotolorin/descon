	...
	<LayoutTemplate>
		<div class="content-panel panel panel-default">
			<div class="panel-heading">
				<asp:HyperLink CssClass="pull-right" NavigateUrl='<%$ CrmSiteMap: SiteMarker=Events, Return=Url %>' Text='<%$ Snippet: Home All Events Link Text, All Events %>' runat="server" />
				<h4>
					<span class="fa fa-calendar" aria-hidden="true"></span>
					<adx:Snippet SnippetName="Home Upcoming Events Heading" DefaultText="Events" EditType="text" runat="server" />
				</h4>
			</div>
			<ul class="list-group">
