...
namespace Site.Areas.Portal
{
	public class PortalAreaRegistration : AreaRegistration
	{
		...
		public override void RegisterArea(AreaRegistrationContext context)
		{
			...
			context.MapRoute("PortalAddSharePointFile", "_services/sharepoint-addfile/{__portalScopeId__}", new {controller = "SharePointGrid", action = "AddSharePointFile"});
			context.MapRoute("PortalDeleteSharePointFile", "_services/sharepoint-deletefile/{__portalScopeId__}", new {controller = "SharePointGrid", action = "DeleteSharePointFile"});
