...
<asp:Content ContentPlaceHolderID="ContentBottom" runat="server">
	<asp:Panel ID="ThankYouPanel" runat="server" CssClass="alert alert-block alert-success" Visible="false">
		<adx:Snippet runat="server" SnippetName="SessionFeedback/ThankyouMessage" DefaultText="Thank you for your feedback." EditType="html" />
	</asp:Panel>

	<asp:Panel ID="SessionScheduleNotFoundMessage" CssClass="alert alert-block alert-danger" Visible="false" runat="server">
		<adx:Snippet runat="server" SnippetName="sessionFeedback/NotFound" DefaultText="The requested session schedule was not found." EditType="html" />
	</asp:Panel>
