		...
		<ul class="toolbar-nav nav nav-tabs">
			<li class="active">
				<a href="#upcoming" data-toggle="tab">
					<adx:Snippet SnippetName="Event Upcoming Tab Text" DefaultText="Upcoming" Literal="True" runat="server"/>
				</a>
			</li>
			<li>
				<a href="#past" data-toggle="tab">
					<adx:Snippet SnippetName="Event Past Tab Text" DefaultText="Past" Literal="True" runat="server"/>
				</a>
			</li>
		</ul>
