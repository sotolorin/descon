				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h1 id="add-note-modal-label" class="modal-title h4">
							<adx:Snippet  runat="server" SnippetName="Ecommerce/Quote/AddNote/ButtonText" DefaultText="Add Note" Editable="true" EditType="text"/>
						</h1>
					</div>
					<div class="modal-body form-horizontal">
						<div class="form-group">
							<asp:Label AssociatedControlID="NewNoteText" CssClass="col-sm-3 control-label" runat="server">
								<adx:Snippet runat="server" SnippetName="Ecommerce/Quote/AddNote/Text" DefaultText="Note" />
							</asp:Label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<asp:Label AssociatedControlID="NewNoteText" CssClass="col-sm-3 control-label" runat="server">
								<adx:Snippet runat="server" SnippetName="cEcommerce/Quote/AddNote/File" DefaultText="Attach a file" />
							</asp:Label>
							<div class="col-sm-9">
					...
					<div class="modal-footer">
						...
						<button class="btn btn-default" data-dismiss="modal" aria-hidden="true">
							<adx:Snippet  runat="server" SnippetName="Ecommerce/Order/AddNote/CancelButtonText" DefaultText="Cancel" Literal="True" EditType="text"/>
						</button>
					</div>
				</div>
			</div>
		...
		<asp:Panel ID="QuoteControls" CssClass="pull-right btn-toolbar" runat="server">
			...
			<asp:Panel ID="AddNote" CssClass="btn-group" runat="server">
				<a href="#add-note" class="btn btn-default" data-toggle="modal">
					...
					<adx:Snippet runat="server" SnippetName="Ecommerce/Quote/AddNote/ButtonText" DefaultText="Add Note" Literal="true" EditType="text"/>
				</a>
			</asp:Panel>
		</asp:Panel>
		<h1>
...
<asp:Content ContentPlaceHolderID="MainContent" ViewStateMode="Enabled" runat="server">
	<asp:Panel ID="GenericError" Visible="False" CssClass="alert alert-block alert-danger" runat="server">
		<adx:Snippet SnippetName="Ecommerce/QuoteGenericErrorMessage" DefaultText="There is an error viewing your quote. Please contact support." EditType="html" runat="server"/>
	</asp:Panel>
	
	<asp:Panel ID="ConvertToOrderError" runat="server" CssClass="alert alert-danger alert-block" Visible="False">
		<a class="close" data-dismiss="alert" href="#">&times;</a>
		<adx:Snippet runat="server" SnippetName="Ecommerce/QuoteConvertToOrderErrorMessage" DefaultText="Conversion of your quote to an order failed. Please contact support." Editable="true" EditType="html" />
	</asp:Panel>
	
	<asp:Panel ID="UpdateSuccessMessage" runat="server" CssClass="alert alert-success alert-block" Visible="False">
		<a class="close" data-dismiss="alert" href="#">&times;</a>
		<adx:Snippet runat="server" SnippetName="Ecommerce/QuoteUpdateSuccessMessage" DefaultText="Your quote has been updated successfully." Editable="true" EditType="html" />
	</asp:Panel>
	...
	<asp:Panel ID="QuoteInfo" runat="server">
		<div class="commerce-status clearfix">
			...
			<span>
				<adx:Snippet SnippetName="Created Label" DefaultText="Created" EditType="text" runat="server"/>
	...
	<asp:Panel ID="QuoteDetails" CssClass="commerce-details" runat="server" Visible="true">
		<asp:Panel ID="ShoppingCartSummary" CssClass="panel panel-default" runat="server">
			<ul class="list-group">
				...
				<li class="list-group-item list-group-item-success">
					...
					<adx:Snippet SnippetName="Total" DefaultText="Total" runat="server" EditType="text" />
				</li>
			</ul>
		</asp:Panel>
		...
		<div class="page-header">
			<h3>
				<adx:Snippet SnippetName="Ecommerce/QuoteNotesLabel" DefaultText="Quote Notes" runat="server" EditType="text" />
			</h3>
		</div>
					...
					<div class="row">
						...
						<div class="col-sm-9">
							...
							<asp:Panel Visible='<%# ((IAnnotation)Container.DataItem).FileAttachment != null %>' CssClass="attachment alert alert-block alert-info" runat="server">
								...
								<asp:HyperLink NavigateUrl='<%# ((IAnnotation)Container.DataItem).Entity.GetFileAttachmentUrl(Website) %>' Text='<%# ((IAnnotation)Container.DataItem).FileAttachment != null ? HttpUtility.HtmlEncode(string.Format("{0} ({1:1})", ((IAnnotation)Container.DataItem).FileAttachment.FileName, ((IAnnotation)Container.DataItem).FileAttachment.FileSize)) : string.Empty %>' runat="server"/>
							</asp:Panel>
						</div>
					</div>
				</div>
