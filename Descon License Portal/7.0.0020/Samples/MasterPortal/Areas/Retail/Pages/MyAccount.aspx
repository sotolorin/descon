...
<asp:Content runat="server" ContentPlaceHolderID="EntityControls">
	...
	<asp:Panel runat="server" ID="Household">
		<fieldset>
			<legend>
				<adx:Snippet SnippetName="My Account Household Form Legend" DefaultText="Household" EditType="text" runat="server"/>
			</legend>
		...
		<fieldset>
			<legend>
				<adx:Snippet SnippetName="My Account Household Members Legend" DefaultText="Household Members" EditType="text" runat="server"/>
			</legend>
