<%@ Page Title="Manage License" Language="C#" MasterPageFile="Restricted.Master" Inherits="System.Web.Mvc.ViewPage<Site.Areas.Account.ViewModels.LicensePaymentViewModel>" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
	<% using (Html.BeginForm("LicensePaymentProcessing", "Manage"))
    { %>
		<%: Html.AntiForgeryToken() %>
		<div class="form-horizontal">
            <fieldset>
             <div hidden="hidden">
                  <%: Html.TextBoxFor(model => model.PaymentModel.CurrencyId) %>
                  <%: Html.TextBoxFor(model => model.PaymentModel.PriceListId) %>
                  <%: Html.TextBoxFor(model => model.PaymentModel.ProductId) %>
                  <%: Html.TextBoxFor(model => model.PaymentModel.QuoteId) %>
                  <%: Html.TextBoxFor(model => model.PaymentModel.PaymentOption) %>
                  <%: Html.TextBoxFor(model => model.PaymentModel.PaymentMethod) %>
                  <%: Html.TextBoxFor(model => model.PaymentModel.SoftwareType) %>
                  <%: Html.TextBoxFor(model => model.PaymentModel.NumberOfUsers) %>
                  <%: Html.TextBoxFor(model => model.PaymentModel.SupportType) %>
                  <%: Html.TextBoxFor(model => model.PaymentModel.LicenseCost) %>
                  <%: Html.TextBoxFor(model => model.PaymentModel.LicenseCostPerUser) %>
             </div>
            <div class="form-group">
		       <span class="col-sm-4 control-label" style="font-size: 18px; font-family: ManiXBold; margin-left: 5% !important">Payment</span>
		    </div>
			...
			<%: Html.ValidationSummary(true, string.Empty, new {@class = "alert alert-block alert-danger"}) %>
               <div class="form-group">
					<div class="col-sm-8" style="font-size:30px; color: RED; font-weight: 600; margin-top: 5px;">
					    <a >PAYMENT PROCESSING...</a>
					</div>
                   <button id="submit-license-update" class="btn2b btn-2" style="margin-top: 15px;"><%: Html.SnippetLiteral("Account/ManageLicense/PurchaseLicense", "Payment Approved") %></button>
				</div>
		</fieldset>
		</div>
	<% } %>
			...
			<div class="col-md-6 form-horizontal">
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input id="x_first_name" name="x_first_name" type="text" value="<%: FirstName %>" class="form-control1" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input id="x_last_name" name="x_last_name" type="text" value="<%: LastName %>" class="form-control1" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input id="x_email" name="x_email" type="text" value="<%: Email %>" class="form-control1" />
						</div>
					</div>
				</fieldset>
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input id="x_address" name="x_address" type="text" value="<%: Address %>" class="form-control1" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input id="x_city" name="x_city" type="text" value="<%: City %>" class="form-control1" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" id="x_state" name="x_state" value="<%: Province %>" class="form-control1" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input id="x_zip" name="x_zip" type="text" value="<%: PostalCode %>" class="form-control1" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" id="x_country" name="x_country" value="<%: Country %>" class="form-control1" />
						</div>
					</div>
				</fieldset>
			</div>
			...
			<div class="col-md-6 form-horizontal">
				...
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input id="x_card_num" name="x_card_num" type="text" value="<%: CreditCardNumber %>" class="form-control1" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-3">
							...
							<select id="ExpiryMonth" name="ExpiryMonth" class="form-control1">
								<option value="">
						...
						<div class="col-sm-3">
							...
							<select id="ExpiryYear" name="ExpiryYear" class="form-control1">
								<option value="">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<div class="input-group">
								<input id="x_card_code" name="x_card_code" type="text" value="<%: CreditCardVerificationValue %>" maxlength="4" class="form-control1" />
