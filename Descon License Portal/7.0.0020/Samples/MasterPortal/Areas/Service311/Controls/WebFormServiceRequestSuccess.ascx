...
<asp:Panel ID="PanelSuccess" runat="server" Visible="False" CssClass="row">
	<div class="col-sm-8">
		<div class="alert alert-success">
			<adx:Snippet ID="DefaultSuccessMessageSnippet" runat="server" Visible="False" SnippetName="311 Service Request Default Success Message" EditType="html" Editable="true" DefaultText="<p><strong><em>Thank you.</em></strong></p><p>Your service request has been successfully submitted.</p><p>Your request will be reviewed within 24 hours and you will receive confirmation and a follow-up message.</p>" ClientIDMode="Static" />
		...
		<asp:Panel ID="ServiceRequestNumberPanel" runat="server" Visible="False">
			<p>
				<adx:Snippet ID="ServiceRequestNumberLabel" 
					...
					DefaultText="Service Request Number:" 
					ClientIDMode="Static" />
				&nbsp;
