<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Portal.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="DesconWeb.Account.Manage" %>
<%@ Register Src="~/Account/OpenAuthProviders.ascx" TagPrefix="uc" TagName="OpenAuthProviders" %>
<%@ Import Namespace="Microsoft.AspNet.Membership.OpenAuth" %>
<asp:Content ContentPlaceHolderID="PortalMainContent" runat="server">
    <hgroup class="title">
        <h1><%: Title %>.</h1>
    </hgroup>
